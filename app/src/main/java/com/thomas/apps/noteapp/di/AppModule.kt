...
import com.thomas.apps.noteapp.feature_login.domain.use_case.Logout
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideLoginRepository(loginApi: LoginApi, localCache: LocalCache): LoginRepository {
    ...
    fun provideLoginUseCase(
        ...
        return LoginUseCases(
            ...
            saveUser = SaveUser(loginRepository),
            logout = Logout(loginRepository, noteRepository)
        )
    }
}